...
preapprovedRouter.get('/submissions', RequiresAuth, async function (req: Request, res: Response) {
    ...
    for(const submission of submissionList) {
        const preapproved = await db('preapproved').select('*').where({'preTSubID': submission.preTSubID})
        for(const preapp of preapproved) {
            const traveler = await db('preapprovedTravelers').select('*').where({'preTID': preapp.preTID})
...
preapprovedRouter.get('/submissions/:submissionId', RequiresAuth, RequiresRolePatAdminOrAdmin, async function (req: Request, res: Response) {
...
preapprovedRouter.post('/submissions/:submissionId', RequiresAuth, RequiresRolePatAdminOrAdmin, async function (req: Request, res: Response) {
...
preapprovedRouter.delete('/submissions/:submissionId', RequiresAuth, RequiresRolePatAdminOrAdmin, async function (req: Request, res: Response){
    try {
        const preTSubID = Number(req.params.submissionId)
        await db.transaction(async (trx) => {
...
preapprovedRouter.post('/approval/:submissionId', RequiresAuth, RequiresRolePatAdminOrAdmin, async function (req: Request, res: Response) {
...
preapprovedRouter.get('/', RequiresAuth, async function (req: Request, res: Response) {
    ...
    const preapprovedList = await db('preapproved')        
        .modify(adminQuery)
...
preapprovedRouter.delete('/:preapprovedId', RequiresAuth, RequiresRolePatAdminOrAdmin, async function (req: Request, res: Response) {
