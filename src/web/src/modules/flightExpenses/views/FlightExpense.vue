            ...
            <v-toolbar  class="" height="100px" flat>
                <v-toolbar-title class="text-h6" style="width:100%">
                    <v-row class="my-10 mx-1">
                        <div style="width:20%;" class="text-h5" >Flight Expense</div>
                        <div style="width:20%;" />
                        ...
                        <div style="width:15%;" >
                            <v-text-field 
                                ...
                                v-model="startDate"
                                :error="startDateErr"
                                @input="startDateErr=false;dataReady=false;"
                                type=date
                                label="Start Date"
                                dense
                                outlined
                        ...
                        <div style="width:15%;" >
                            <v-text-field 
                                ...
                                v-model="endDate"
                                :error="endDateErr"
                                @input="endDateErr=false;dataReady=false;"
                                type=date
                                label="End Date"
                                dense
                                outlined
                ...
                <template v-slot:extension>
                    <v-tabs v-model="tabs" active-class="primary--text teal lighten-5" v-if="dataReady">
                        <v-tab>Flights</v-tab>
...
export default {
    ...
    methods: {
        ...
        async search(){            
            ...
            if(diffDays>60)
                this.alertMsg= "If the Date Range is over 60 days, all records may not be displayed. Please use a shorter Date Range."
