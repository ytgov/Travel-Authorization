      ...
      },
      {
        ...
        children: [
          ...
          },
          {
            ...
            path: "travel-desk/:travelDeskTravelRequestId/flight-requests/:travelDeskFlightRequestId/edit-flight-options",
            component: () => import("@/pages/travel-desk/TravelDeskFlightOptionsEditPage.vue"),
            props: true,
          },
        ],
      },
